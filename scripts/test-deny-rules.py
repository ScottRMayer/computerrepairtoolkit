...
MUST_PASS = [
    ...
    ("PowerShell", "Get-Process | Format-List | Out-String"),
    ("PowerShell", "wevtutil qe System /format:text /c:5"),
    ("PowerShell", "Get-CimInstance Win32_Volume | Select-Object DriveLetter, Label"),
    ...
    ("PowerShell", r"E:\tools\msert\msert.exe /f /q"),
    ("PowerShell", r"E:\tools\adwcleaner\adwcleaner.exe /eula /clean /noreboot"),
    ("PowerShell", r'E:\tools\bleachbit\bleachbit_console.exe --preview system.tmp'),
    ("PowerShell", "manage-bde -status"),
    ("PowerShell", "manage-bde -status C:"),
    ("PowerShell", "pnputil /enum-drivers"),
    ("PowerShell", "pnputil /delete-driver oem42.inf /uninstall"),
    ("PowerShell", r'icacls "C:\ProgramData\app" /reset'),
    ("PowerShell", "fsutil dirty query C:"),
    ("PowerShell", "ipconfig /flushdns"),
    ("PowerShell", "Repair-Volume -DriveLetter C -Scan"),
...
MUST_BLOCK = [
    ...
    ("PowerShell", "cmd /c format c: /y"),
    ("PowerShell", "cmd.exe /k format d:"),
    ("PowerShell", 'Invoke-CimMethod -Query "SELECT * FROM Win32_Volume WHERE DriveLetter=\'D:\'" -MethodName Format'),
    ("Bash", "cmd /c format c:"),
    ...
    ("PowerShell", "manage-bde -forcerecovery C:"),
